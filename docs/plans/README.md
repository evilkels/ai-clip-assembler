...
| [review-model-sign-in-followups](review-model-sign-in-followups.md) | IN PROGRESS (2026-07-21) — PR #56 review follow-ups; safe cleanups + one-component-per-file splits landed, spec-record reconciliation (Tasks 2–3) open. |
