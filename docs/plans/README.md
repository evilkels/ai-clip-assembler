...
| [settings-page](done/settings-page.md) | DONE (2026-07-03) — shipped as Settings & Diagnostics modal (`8523ed9`) plus theme switching (`cd1ef24`); closed to match the delivered global settings/theme/diagnostics slice. |
