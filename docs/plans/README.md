...
- **Numbered advisor plans** (`001-…`–`00N-…`) — self-contained executor
  ...
  candidate-quality/review-chat audit on 2026-06-21 at `6744eaa`. Execute in
  numbered order unless dependencies say otherwise. Each executor: read the
  plan fully before starting, honor its STOP conditions, and update the row.
...
| [005](005-rich-candidate-pool.md) | Separate rich Candidate Clip discovery from draft selection | P1 | M | — | TODO |
